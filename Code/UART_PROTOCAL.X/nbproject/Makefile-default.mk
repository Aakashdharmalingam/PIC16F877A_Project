...
FINAL_IMAGE=${DISTDIR}/UART_PROTOCAL.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/UART_PROTOCAL.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
